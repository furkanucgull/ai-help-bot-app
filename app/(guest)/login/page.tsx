...
const LoginPage = () => {
    return (
        <div className='flex py-10 md:py-0 flex-col flex-1 justify-center items-center bg-[#1aacef]'>
            <div className=' grid grid-cols-1 md:grid-cols-2 gap-5'>
                <div className='flex flex-col items-center justify-center space-y-5 text-white'>
                    <div className='rounded-full bg-white p-5'>
                        <Avatar seed='Furkan Support AI' className='h-60 w-60' />
                    </div>
                    <div className='text-center'>
                        <h1 className='text-4xl'> Assistant </h1>
