...
export const INSERT_MESSAGE = gql`
  mutation insertMessages($chat_session_id: Int!, $content: String!, $sender: String!, $created_at: DateTime!) {
    insertMessages(chat_session_id: $chat_session_id, content: $content, sender: $sender, created_at: $created_at) {
      id
      content
      created_at
      sender
...
export const INSERT_CHAT_SESSION = gql`
  mutation insertChat_sessions($chatbot_id: Int!, $guest_id: Int!, $created_at: DateTime!) {
